...
["_CheckWasm","_SortDependencyTree","_GetDependencies","_GetFileExtension","_FindHTMLDependencies","_FatalInvalidFile","_ReadDataFromFile","_DependencyFromRegexMatch","_CreateTree","_TurnToFullRelativePath","_GetLastFullstop","_LastOccurenceOfChar","_containsCharacter","_getSubstring","_GetNumOfRegexMatches","_GetBasePath","_StringStartsWith","_GetAllRegexMatches","_HasRegexMatch","_regextest","_BasicRegexDependencies","_FindCSSDependencies","_SendSettingsString","_BundleFiles","_fflush","___set_stack_limits","onRuntimeInitialized"].forEach((prop) => {
...
var ASM_CONSTS = {
  55772: () => { return withBuiltinMalloc(function () { return allocateUTF8(Module['UBSAN_OPTIONS'] || 0); }); },  
 55870: () => { var setting = Module['printWithColors']; if (setting != null) { return setting; } else { return ENVIRONMENT_IS_NODE && process.stderr.isTTY; } }
};
...
/** @type {function(...*):?} */
var _DependencyFromRegexMatch = Module["_DependencyFromRegexMatch"] = createExportWrapper("DependencyFromRegexMatch");

/** @type {function(...*):?} */
var _CreateTree = Module["_CreateTree"] = createExportWrapper("CreateTree");

/** @type {function(...*):?} */
var _TurnToFullRelativePath = Module["_TurnToFullRelativePath"] = createExportWrapper("TurnToFullRelativePath");

/** @type {function(...*):?} */
var _GetLastFullstop = Module["_GetLastFullstop"] = createExportWrapper("GetLastFullstop");
...
/** @type {function(...*):?} */
var _regextest = Module["_regextest"] = createExportWrapper("regextest");
