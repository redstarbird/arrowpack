...
["_CheckWasm","_GetDependencies","_GetFileExtension","_FindHTMLDependencies","_FindCSSDependencies","_FindJSDependencies","_FatalInvalidFile","_ReadDataFromFile","_CreateGraph","_TurnToFullRelativePath","_LastOccurenceOfChar","_containsCharacter","_getSubstring","_GetNumOfRegexMatches","_GetTrueBasePath","_GetBasePath","_StringStartsWith","_HasRegexMatch","_CombineRegexMatchArrays","_GetRegexMatch","_GetAllRegexMatches","_BasicRegexDependencies","_SendSettingsString","_InitFileTypes","_BundleFiles","_fflush","___set_stack_limits","onRuntimeInitialized"].forEach((prop) => {
...
var ASM_CONSTS = {
  101692: () => { return withBuiltinMalloc(function () { return allocateUTF8(Module['UBSAN_OPTIONS'] || 0); }); },  
 101790: () => { var setting = Module['printWithColors']; if (setting != null) { return setting; } else { return ENVIRONMENT_IS_NODE && process.stderr.isTTY; } }
};
...
/** @type {function(...*):?} */
var _SendSettingsString = Module["_SendSettingsString"] = createExportWrapper("SendSettingsString");
