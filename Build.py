...
def Build():
    ...
    CBuildFiles = (
        ...
        "./src/Regex/RegexFunctions.c", "./src/DependencyGraph/FindDependencies.c","./src/SettingsSingleton/settingsSingleton.c", 
         "./src/C/ProblemHandler.c", "./src/C/TextColors.c", "./src/C/FileHandler.c", "./src/C/IntFunctions.c", "./src/Minifiers/HTMLMinifier.c", "./src/C/FileTypesHandler.c", "./src/C/Stack.c", "./src/C/BundleFiles.c", "./src/C/ProgressBar.c", "./src/C/StringShiftHandler.c", "./src/Minifiers/JSMinifier.c", "./src/Transformers/Transform.c", "./src/Plugins/Plugins.c"),
        Modularize=True,
    ...
    def BuildLinux():
        ...
        for value in CBuildFiles:
            ...
            optimizations = "-O3 -s ELIMINATE_DUPLICATE_FUNCTIONS=1 -s MINIFY_HTML=1 "
