...
void BundleFile(struct Node *GraphNode)
{
    ...
    struct ShiftLocation *ShiftLocations = malloc(sizeof(ShiftLocation)); // Allocate shift locations
    ...
    while (CurrentEdge != NULL) // Loop through each dependency
    {
        ...
        char *InsertText = ReadDataFromFile(DependencyExitPath);    // The file contents of the dependency
