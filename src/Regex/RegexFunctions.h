...
RegexMatch EMSCRIPTEN_KEEPALIVE *
GetAllRegexMatches(char *Text, const char *Pattern, unsigned int StartPos,
                   unsigned int EndPos);  // returns all regex matches as an array of strings
